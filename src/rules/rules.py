...
class Rules:
    ...
    headlines: List[HeadlineRules] = [
        HeadlineRules("INLEDNING",
                      order=1,
                      required=True,
                      named_entities=[NamedEntityRule("Texten under rubriken INLEDNING behöver en tidpunkt.", identity="TIMEX", cheat=r"\d{1,2}[:|\.]\d{1,2}"),
                                      NamedEntityRule("Texten under rubriken INLEDNING behöver en adress.", identity="ENAMEX", type="LOC")]),
